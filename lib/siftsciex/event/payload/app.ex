defmodule Siftsciex.Event.Payload.App do
  @moduledoc """
  ...
  defstruct "$os": :empty,
            ...
            "$app_name": :empty,
            "$app_version": :empty
  @type t :: %__MODULE__{"$os": Payload.payload_string,
                         "$os_version": Payload.payload_string,
                         "$device_manufacturer": Payload.payload_string,
                         "$device_model": Payload.payload_string,
                         "$device_unique_id": Payload.payload_string,
                         "$app_name": Payload.payload_string,
                         "$app_version": Payload.payload_string}
  @type attribute :: :os
                     | :os_version
                     | :device_manufacturer
                     | :device_model
