defmodule Siftsciex.Body.Event.Discount do
  @moduledoc """
  ...
  alias Siftsciex.{Body, Currency}

  defstruct "$percentage_off": :empty,
            "$amount": :empty,
            "$currency_code": :empty,
            "$minimum_purchase_amount": :empty
  @type t :: %__MODULE__{"$percentage_off": Body.payload_float,
                         "$amount": Body.payload_int,
                         "$currency_code": Body.payload_string,
                         "$minimum_purchase_amount": Body.payload_int}
